...
extension GLHKView: GLKViewDelegate {
    ...
    public func glkView(_ view: GLKView, drawIn rect: CGRect) {
        ...
        if let rotation = rotation {
            switch rotation {
            case 1: // 90
                displayImage = displayImage.oriented(forExifOrientation: 6)
            case 2: // 180
                displayImage = displayImage.oriented(forExifOrientation: 3)
            case 3: // 270
                displayImage = displayImage.oriented(forExifOrientation: 8)
            default:
                break
            }
        }
